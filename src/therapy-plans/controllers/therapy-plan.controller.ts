...
export class TherapyPlanController {
  ...
  create(@Body() createTherapyPlanDto: CreateTherapyPlanDto): Promise<TherapyPlanDto> {
  ...
  @ApiBadRequestResponse({ 
    description: 'Não é possível excluir o plano pois existem assinaturas ativas' 
  })
