...
export class TherapyPlansController {
  ...
  async create(
    @Body() createPlanDto: CreateTherapyPlanDto,
  ...
  @ApiResponse({
    ...
    description: 'Plano não pode ser removido',
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Filial adicionada ao plano',
    type: TherapyPlanDto,
  })
  async addBranch(
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Filial removida do plano',
    type: TherapyPlanDto,
  })
  async removeBranch(
    @Param('id') planId: string,
