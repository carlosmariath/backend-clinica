...
export class CreateTherapyPlanDto {
  ...
  @IsNumber(
    ...
    { message: 'O número de sessões deve ser um número válido' },
  )
  ...
  @IsNumber(
    { allowNaN: false, allowInfinity: false },
    { message: 'Os dias de validade devem ser um número válido' },
  )
  ...
  @ArrayMinSize(1, {
    message: 'O plano deve estar associado a pelo menos uma filial',
  })
  @IsUUID('4', {
    each: true,
    message: 'Todos os IDs de filiais devem ser UUIDs válidos',
  })
  branchIds: string[];
}
