...
export class SubscriptionsController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar todas as assinaturas com filtros opcionais',
  })
  @ApiQuery({
    name: 'clientId',
    required: false,
  ...
  @ApiQuery({
    name: 'branchId',
    required: false,
    description: 'Filtrar por uma filial específica',
  })
  @ApiQuery({
    name: 'branchIds',
    required: false,
    description: 'Filtrar por múltiplas filiais',
    isArray: true,
  })
  @ApiQuery({
    name: 'page',
